...
class __Mustache_04cbda4486125d3ecff08e53327cf23e extends Mustache_Template
{
...
';
        ...
        $buffer .= $this->sectionDe14c17c6a08745de738275afac67a4c($context, $indent, $value);
        $buffer .= $indent . '</nav>
';
...
';
    ...
    private function section038f466055ce770aefe7de56fe6d17d9(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
...
';
    ...
    private function sectionDe14c17c6a08745de738275afac67a4c(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
...
';
            ...
            foreach ($values as $value) {
                ...
                $buffer .= $this->section038f466055ce770aefe7de56fe6d17d9($context, $indent, $value);
